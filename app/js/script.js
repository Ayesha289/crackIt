...
let questions = [
  ...
  {
  numb: 5,
  question: "Which of the following countries follow Presidential system of government ?",
  answer: "USA",
  options: [
    "India",
    "USA",
...
{
  numb: 8,
  question: "Which of the following is the fastest cruise missile in the world",
  answer: "Brahmos",
  options: [
    "Agni",
    "Brahmos",
...
{
  numb: 14,
  question: "Along with Sardar Patel who is responsible for integrating all the princely states in India",
  answer: "VP Menon",
  options: [
    "VP Menon",
    "C Rajgolachari",
...
{
  numb: 19,
  question: "River Indus passes through which of the following territories of India",
  answer: "J & K",
  options: [
    "J & K",
    "Punjab",
...
{
  numb: 20,
  question: "All the places part of 'Chota Char Dham' are a part of which state",
  answer: "Uttarakhand",
  options: [
      "J & K",
      "Punjab",
